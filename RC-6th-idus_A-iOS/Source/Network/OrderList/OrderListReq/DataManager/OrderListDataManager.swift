...
class OrderListDataManager{
    func requireLOrderList(_ viewController : UIViewController, _ completion: @escaping (_ data: [OrderListResult]) -> Void){
        ...
        AF.request("\(Constant.BASE_URL)/users/\(Constant.USER_ID)/order-lists", method: .get, encoding: JSONEncoding.default, headers: headers)
